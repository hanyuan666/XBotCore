...
#ifndef __X_BOT_IDDP_EXAMPLE_2_H__
#define __X_BOT_IDDP_EXAMPLE_2_H__
...
class XBot::IDDPExample2 : public XBot::Thread_hook
                        
{
public:
    
    IDDPExample2();
    virtual ~IDDPExample2();    
...
private:
    ...
    XBot::PublisherIDDP<Eigen::Vector3d> pub_vec;
...
#endif //__X_BOT_IDDP_EXAMPLE_2_H__
